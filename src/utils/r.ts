/*
	Наивная реализация фабрики createElement и renderDOM.
	Буду допиливать в следующих спринтах.
 */
...
export function createElement(
  ...
  config: any,
  ...args: (JSX.Element | "string" | null | boolean)[]
): JSX.Element {
  ...
  props.children = args
    ...
    .map((c) =>
      typeof c === "string" || typeof c === "number" ? createTextElement(c) : c,
    ) as JSX.Element[];
...
export function renderDOM(element: JSX.Element, parentDom: HTMLElement): void {
  ...
  childElements.forEach((childElement) =>
    renderDOM(childElement, dom as HTMLElement),
  );
